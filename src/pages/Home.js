    ...
    <div>
      ...
      <div className='section'>
        <div>
          ...
          <p>Our kitchen closes 2.5-3 hours before we close!</p></div>
        <div><h1>Visit Soon!</h1></div>
      </div>
      ...
      <div className='section'>
        <div>
          ...
          <p>Phone: 718-971-1684</p></div></div>
      ...
      <div className='section'>
        <div>
          ...
          <div>
            ...
            <p>For large parties (9+ or more people), please email us at sipnplaynyc@gmail.com to inquire about a reservation. </p>
            <button
      ...
      <div className='section'>
        <div><h1>How it works</h1>
          <p>Come on in with your friends and family and play boardgames from our collection of over 500+ games! Just $10 a person for 3 hours of gameplay. ($12 a person Friday-Sunday and Holidays) </p>
          <p>Play while enjoying bubble tea, coffee, beer sandwiches or salads and have a great time! If you want to guarantee a table, you can make a reservation which is $15 a person for 3 hours of gameplay.</p>
        </div> </div>

      {/* Bloomburron */}
      <div className='section'>
        <div><h1>Bloomburrow Pre-release</h1>
          <ul>
      ...
      <div className='section'>
        <div><h1>Disney Lorcana Even</h1>
          ...
          <h2>Disney Lorcana Even</h2>
          <p>Want to play the new Disney trading card game? We're hosting a Lorcana learn to play event on July 22nd 6pm! Just grab a starter deck at Sip & Play and we'll have players on hand to teach you.</p>
          <p>Excited to see you there!</p></div></div>
